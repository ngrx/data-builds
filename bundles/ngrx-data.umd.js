(function (global, factory) {
  ...
  function excludeEmptyChangeSetItems(changeSet) {
      ...
      return __assign$1(__assign$1({}, changeSet), { changes: changes });
  }
  ...
  SaveEntities = /** @class */ (function () {
      function SaveEntities(changeSet, url, options) {
          ...
          this.payload = __assign$2(__assign$2({ changeSet: changeSet, url: url }, options), { tag: changeSet.tag });
      }
      return SaveEntities;
  }());
  if (false) {
  ...
  function createEntityDefinition(metadata) {
      ...
      /** @type {?} */
      var initialState = entityAdapter.getInitialState(__assign$4({ entityName: entityName, filter: '', loaded: false, loading: false, changeState: {} }, (metadata.additionalCollectionState || {})));
      /** @type {?} */
  ...
  var EntityDefinitionService = /** @class */ (function () {
      ...
      function (metadataMap) {
           ...
           */
          function (entityName) {
              return _this.registerMetadata(__assign$5({ entityName: entityName }, metadataMap[entityName]));
          }));
      };
      /**
      ...
      function (changeSet) {
          ...
          function (item) {
              if (item.op === updateOp && item.entities.length > 0) {
                  hasMutated = true;
                  return __assign$6(__assign$6({}, item), { entities: ((/** @type {?} */ (item))).entities.map((/**
                       * @param {?} u
                       * @return {?}
                       */
          ...
          return hasMutated ? __assign$6(__assign$6({}, changeSet), { changes: changes }) : changeSet;
      };
      /**
      ...
      function (changeSet) {
          ...
          function (item) {
              if (item.op === updateOp) {
                  ...
                  return (/** @type {?} */ (__assign$6(__assign$6({}, item), { entities: item.entities.map((/**
                       * @param {?} u
                       * @return {?}
                       */
                      function (u) { return ({
  ...
  var EntityCacheDispatcher = /** @class */ (function () {
      ...
      function (changes, url, options) {
          ...
          options = __assign$8(__assign$8({}, options), { correlationId: correlationId, isOptimistic: isOptimistic, tag: tag });
          /** @type {?} */
  ...
  EntityDispatcherBase = /** @class */ (function () {
      ...
      function (entityOp, data, options) {
          return this.entityActionFactory.create(__assign$9({ entityName: this.entityName, entityOp: entityOp,
              data: data }, options));
      };
      /**
       * Create an {EntityAction} for this entity type and
      ...
      function (entity, options) {
           ...
           */
          function (_a) {
              var _b = __read$1(_a, 2), e = _b[0], collection = _b[1];
      ...
      function (options) {
           ...
           */
          function (_a) {
              var _b = __read$1(_a, 2), entities = _b[0], collection = _b[1];
      ...
      function (key, options) {
           ...
           */
          function (_a) {
              var _b = __read$1(_a, 2), entity = _b[0], collection = _b[1];
      ...
      function (options) {
          ...
          var correlationId = options.correlationId == null
              ? this.correlationIdGenerator.next()
              : options.correlationId;
          return __assign$9(__assign$9({}, options), { correlationId: correlationId });
      };
      /**
       * @private
       * @param {?=} options
      ...
      function (options, defaultOptimism) {
          ...
          var isOptimistic = options.isOptimistic == null
              ...
              : options.isOptimistic === true;
          return __assign$9(__assign$9({}, options), { correlationId: correlationId, isOptimistic: isOptimistic });
      };
  ...
  var EntityDispatcherFactory = /** @class */ (function () {
      ...
      defaultOptions) {
          ...
          /** @type {?} */
          var options = __assign$a(__assign$a({}, this.entityDispatcherDefaultOptions), defaultOptions);
  ...
  var EntityCacheEffects = /** @class */ (function () {
      function EntityCacheEffects(actions, dataService, entityActionFactory, logger, scheduler) {
           ...
           */
          function () {
              return _this.actions.pipe(effects.ofType(EntityCacheAction.SAVE_ENTITIES_CANCEL), operators.filter((/**
               * @param {?} a
               * @return {?}
               */
           ...
           */
          function () {
              return _this.actions.pipe(effects.ofType(EntityCacheAction.SAVE_ENTITIES), operators.mergeMap((/**
               * @param {?} action
               * @return {?}
               */
  ...
  var EntityEffects = /** @class */ (function () {
      function EntityEffects(actions, dataService, entityActionFactory, resultHandler, scheduler) {
           ...
           */
          function () {
              return _this.actions.pipe(ofEntityOp(EntityOp.CANCEL_PERSIST), operators.map((/**
               * @param {?} action
               * @return {?}
               */
           ...
           */
          function () {
              return _this.actions.pipe(ofEntityOp(persistOps), operators.mergeMap((/**
               * @param {?} action
               * @return {?}
               */
              ...
              case EntityOp.SAVE_UPDATE_ONE:
                  ...
                  function (updatedEntity) {
                      ...
                      var responseData = hasData
                          ? { id: id_1, changes: __assign$b(__assign$b({}, changes_1), updatedEntity), changed: true }
  ...
  var EntitySelectorsFactory = /** @class */ (function () {
      ...
      function (metadataOrName) {
          ...
          return (/** @type {?} */ (__assign$c({ selectCount: selectCount,
      ...
      function (metadataOrName) {
          ...
          return (/** @type {?} */ (__assign$c({ entityName: entityName,
  ...
  EntityChangeTrackerBase = /** @class */ (function () {
      ...
      function (collection) {
          return Object.keys(collection.changeState).length === 0
              ? collection
              : __assign$d(__assign$d({}, collection), { changeState: {} });
      };
      /**
      ...
      function (entityOrIdList, collection) {
          ...
          return didMutate ? __assign$d(__assign$d({}, collection), { changeState: changeState }) : collection;
      };
      /**
      ...
      function (updateResponseData, collection, mergeStrategy, skipUnchanged) {
          ...
          switch (mergeStrategy) {
              ...
              case MergeStrategy.OverwriteChanges:
                  ...
                  collection = didMutate ? __assign$d(__assign$d({}, collection), { changeState: changeState }) : collection;
                  updates = filterChanged(updateResponseData);
                  return this.adapter.updateMany(updates, collection);
              case MergeStrategy.PreserveChanges: {
                  ...
                  function (chgState, update) {
                      ...
                      if (change) {
                          ...
                          /** @type {?} */
                          var newOrigValue = __assign$d(__assign$d({}, ((/** @type {?} */ ((/** @type {?} */ (oldChangeState)).originalValue)))), ((/** @type {?} */ (update.changes))));
                          ((/** @type {?} */ (chgState)))[newId] = __assign$d(__assign$d({}, oldChangeState), { originalValue: newOrigValue });
                      }
                      else {
          ...
          switch (mergeStrategy) {
              ...
              case MergeStrategy.PreserveChanges: {
                  ...
                  function (chgState, entity) {
                      ...
                      if (change) {
                          if (!didMutate) {
                              chgState = __assign$d(__assign$d({}, chgState), (_a = {}, _a[id] = __assign$d(__assign$d({}, (/** @type {?} */ (chgState[id]))), { originalValue: entity }), _a));
                              didMutate = true;
                          }
                      }
                      else {
      ...
      function (collection) {
          ...
          return __assign$d(__assign$d({}, collection), { changeState: {} });
      };
      /**
  ...
  EntityCollectionReducerMethods = /** @class */ (function () {
      ...
      function (collection, action) {
          ...
          return __assign$e(__assign$e({}, this.entityChangeTracker.mergeQueryResults(data, collection, mergeStrategy)), { loaded: true, loading: false });
      };
      /**
       * @protected
       * @param {?} collection
      ...
      function (collection, action) {
          /** @type {?} */
          var data = this.extractData(action);
          return __assign$e(__assign$e({}, this.adapter.addAll(data, collection)), { loading: false, loaded: true, changeState: {} });
      };
      /**
       * @protected
       * @param {?} collection
      ...
      function (collection, action) {
          ...
          /** @type {?} */
          var mergeStrategy = this.extractMergeStrategy(action);
          return __assign$e(__assign$e({}, this.entityChangeTracker.mergeQueryResults(data, collection, mergeStrategy)), { loading: false });
      };
      ...
      function (collection, action) {
          /** @type {?} */
          var entities = this.guard.mustBeEntities(action);
          return __assign$e(__assign$e({}, this.adapter.addAll(entities, collection)), { loading: false, loaded: true, changeState: {} });
      };
      /**
       * @protected
       * @param {?} collection
       ...
       */
      function (collection, action) {
          return __assign$e(__assign$e({}, this.adapter.removeAll(collection)), { loaded: false, loading: false, changeState: {} });
      };
      /**
       * @protected
       * @param {?} collection
      ...
      function (collection, action) {
          ...
          return collection.changeState === changeState
              ? collection
              : __assign$e(__assign$e({}, collection), { changeState: changeState });
      };
      /**
      ...
      function (collection, action) {
          ...
          return collection.filter === filter
              ? collection
              : __assign$e(__assign$e({}, collection), { filter: filter });
      };
      /**
       * @protected
       * @param {?} collection
      ...
      function (collection, action) {
          ...
          return collection.loaded === loaded
              ? collection
              : __assign$e(__assign$e({}, collection), { loaded: loaded });
      };
      /**
       * @protected
       * @param {?} collection
      ...
      function (collection, loading) {
          ...
          return collection.loading === loading
              ? collection
              : __assign$e(__assign$e({}, collection), { loading: loading });
      };
  ...
  var EntityCacheReducerFactory = /** @class */ (function () {
      ...
      function (cache, action) {
          ...
          return action.payload.error || collection === (/** @type {?} */ (newCollection))
              ? cache
              : __assign$f(__assign$f({}, cache), (_a = {}, _a[entityName] = (/** @type {?} */ (newCollection)), _a));
      };
      ...
      function (entityCache, entityNames) {
          ...
          function (entityName) {
              ...
              if (collection.loading) {
                  if (!isMutated) {
                      entityCache = __assign$f({}, entityCache);
                      isMutated = true;
                  }
                  entityCache[entityName] = __assign$f(__assign$f({}, collection), { loading: false });
              }
          }));
          return entityCache;
      };

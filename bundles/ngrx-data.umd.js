(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    exports.ChangeSetOperation = void 0;
    ...
    exports.EntityCacheAction = void 0;
    ...
    var EntityDefinitionService = /** @class */ (function () {
        ...
        EntityDefinitionService.prototype.registerMetadataMap = function (metadataMap) {
            ...
            Object.keys(metadataMap || {}).forEach(function (entityName) { return _this.registerMetadata(Object.assign({ entityName: entityName }, metadataMap[entityName])); });
        };
        /**
        ...
        EntityCacheDataService.prototype.flattenUpdates = function (changeSet) {
            ...
            changes = changes.map(function (item) {
                if (item.op === updateOp && item.entities.length > 0) {
                    hasMutated = true;
                    return Object.assign(Object.assign({}, item), { entities: item.entities.map(function (u) { return u.changes; }) });
                }
                else {
                    return item;
                }
        ...
        EntityCacheDataService.prototype.restoreUpdates = function (changeSet) {
            ...
            changes = changes.map(function (item) {
                if (item.op === updateOp) {
                    ...
                    return Object.assign(Object.assign({}, item), { entities: item.entities.map(function (u) { return ({
                            id: selectId_1(u),
                            changes: u,
                        }); }) });
                }
    ...
    var DefaultPersistenceResultHandler = /** @class */ (function () {
        ...
        DefaultPersistenceResultHandler.prototype.handleSuccess = function (originalAction) {
            ...
            return function (data) { return _this.entityActionFactory.createFromAction(originalAction, {
                entityOp: successOp,
                data: data,
            }); };
        };
    ...
    var EntityCacheDispatcher = /** @class */ (function () {
        ...
        EntityCacheDispatcher.prototype.getSaveEntitiesResponseData$ = function (crid) {
             ...
             */
            return this.reducedActions$.pipe(operators.filter(function (act) { return act.type === exports.EntityCacheAction.SAVE_ENTITIES_SUCCESS ||
    ...
    var ENTITY_EFFECTS_SCHEDULER = new core.InjectionToken('@ngrx/data Entity Effects Scheduler');
    ...
    var EntityCacheEffects = /** @class */ (function () {
        ...
        scheduler) {
             ...
             */
            this.saveEntitiesCancel$ = effects.createEffect(function () { return _this.actions.pipe(effects.ofType(exports.EntityCacheAction.SAVE_ENTITIES_CANCEL), operators.filter(function (a) { return a.payload.correlationId != null; })); }, { dispatch: false });
            // Concurrent persistence requests considered unsafe.
            // `mergeMap` allows for concurrent requests which may return in any order
            this.saveEntities$ = effects.createEffect(function () { return _this.actions.pipe(effects.ofType(exports.EntityCacheAction.SAVE_ENTITIES), operators.mergeMap(function (action) { return _this.saveEntities(action); })); });
        }
        /**
        ...
        EntityCacheEffects.prototype.handleSaveEntitiesSuccess$ = function (action, entityActionFactory) {
            ...
            return function (changeSet) {
                ...
                var entityNames = changeSet.changes.reduce(function (acc, item) { return acc.indexOf(item.entityName) === -1
                    ...
                    : acc; }, []);
                return rxjs.merge(entityNames.map(function (name) { return entityActionFactory.create(name, exports.EntityOp.SET_LOADING, false); }));
            };
        };
    ...
    var EntityEffects = /** @class */ (function () {
        ...
        scheduler) {
             ...
             */
            this.cancel$ = effects.createEffect(function () { return _this.actions.pipe(ofEntityOp(exports.EntityOp.CANCEL_PERSIST), operators.map(function (action) { return action.payload.correlationId; }), operators.filter(function (id) { return id != null; })); }, { dispatch: false });
            // `mergeMap` allows for concurrent requests which may return in any order
            this.persist$ = effects.createEffect(function () { return _this.actions.pipe(ofEntityOp(persistOps), operators.mergeMap(function (action) { return _this.persist(action); })); });
        }
        /**
        ...
        EntityEffects.prototype.persist = function (action) {
            ...
            try {
                ...
                var c = this.cancel$.pipe(operators.filter(function (id) { return action.payload.correlationId === id; }), operators.map(function (id) { return _this.entityActionFactory.createFromAction(action, {
        ...
        EntityEffects.prototype.callDataService = function (action) {
            ...
            switch (entityOp) {
                ...
                case exports.EntityOp.SAVE_UPDATE_ONE:
                    var id_1 = data.id, changes_1 = data.changes; // data must be Update<T>
        ...
        EntityEffects.prototype.handleError$ = function (action) {
            ...
            // ensure observable takes some time,
            // as app likely assumes asynchronous response.
            return function (error) { return rxjs.of(_this.resultHandler.handleError(action)(error)).pipe(operators.delay(_this.responseDelay, _this.scheduler || rxjs.asyncScheduler)); };
        };
        /**
    ...
    var EntitySelectors$Factory = /** @class */ (function () {
        function EntitySelectors$Factory(store, actions, selectEntityCache) {
            ...
            this.entityActionErrors$ = actions.pipe(operators.filter(function (ea) { return ea.payload &&
                ea.payload.entityOp &&
                ...
                case exports.MergeStrategy.PreserveChanges: {
                    ...
                    changeState = updateResponseData.reduce(function (chgState, update) {
                        ...
                        if (change) {
                            ...
                            var newOrigValue = Object.assign(Object.assign({}, oldChangeState.originalValue), update.changes);
            ...
            switch (mergeStrategy) {
                ...
                case exports.MergeStrategy.PreserveChanges: {
                    ...
                    changeState = entities.reduce(function (chgState, entity) {
                        ...
                        if (change) {
                            if (!didMutate) {
                                chgState = Object.assign(Object.assign({}, chgState), (_a = {}, _a[id] = Object.assign(Object.assign({}, chgState[id]), { originalValue: entity }), _a));
                                didMutate = true;
                            }
                        }
                        else {
    ...
    var EntityCacheReducerFactory = /** @class */ (function () {
        ...
        EntityCacheReducerFactory.prototype.mergeQuerySetReducer = function (entityCache, action) {
            ...
            var entityOp = exports.EntityOp.QUERY_MANY_SUCCESS;
        ...
        EntityCacheReducerFactory.prototype.applyCollectionReducer = function (cache, action) {
            ...
            return action.payload.error || collection === newCollection
                ? cache
                : Object.assign(Object.assign({}, cache), (_a = {}, _a[entityName] = newCollection, _a));
        };
    ...
    */
    ...
    EntityDataModuleWithoutEffects.decorators = [
        { type: core.NgModule, args: [{
                    imports: [
                        store.StoreModule, // rely on Store feature providers rather than Store.forFeature()
                    ],
                    providers: [
                        CorrelationIdGenerator,
    ...
    EntityDataModule.decorators = [
        { type: core.NgModule, args: [{
                    imports: [
                        ...
                        effects.EffectsModule, // do not supply effects because can't replace later
                    ],
                    providers: [
